...
import { BarChart3, TrendingUp, Search, CheckCircle2 } from 'lucide-react'
    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-5xl font-bold text-gray-900 leading-tight">
                Unlock Comprehensive U.S. Trade Insights
              </h1>
              <p className="mt-6 text-xl text-gray-600">
                Explore HS8/HS10 trade data, market trends, and actionable insights to make informed decisions in global trade.
              </p>
              <div className="mt-10 flex items-center space-x-4">
                ...
                <Link
                  to="/login"
                  className="text-blue-600 px-6 py-3 rounded-lg text-lg font-medium hover:bg-blue-50 transition-colors"
                >
                  Sign In
                </Link>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              ...
              >
                {plan.popular && (
                  <div className="absolute top-0 right-8 -translate-y-1/2 bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-medium">
                    Popular
                  </div>
                )}
                <div>
      ...
      <section className="py-24 bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            to="/signup"
            className="mt-8 inline-block bg-white text-blue-600 px-8 py-4 rounded-lg text-lg font-medium hover:bg-blue-50 transition-colors"
          >
